...
export async function updateLoggedInUserFollowing(
  ...
  profileId, // the user that logged user requests to follow
  isFollowingProfile // question boolean (am I currently following this person?)
  ) {
...
export async function isUserFollowingProfile(loggedInUserUsername, profileUserId) {
  ...
  .where('username', '==', loggedInUserUsername).where('following', 'array-contains', profileUserId).get();
